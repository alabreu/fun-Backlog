...
export const en: Record<keyof typeof pt, string> = {
  ...
  'shelf.stackCount': '{count} works in this franchise',
  ...
  'item.newSeasonConfirm': 'Start watching again',
  'item.finishedConfirm': 'Mark as finished',
  'item.ratingLabel': 'Rating',
  'item.favorite': 'Favourite',
  'item.sourceScore': '{source} score: {value} out of 100',
  'item.favoriteCount': 'Favourites: {count}',
