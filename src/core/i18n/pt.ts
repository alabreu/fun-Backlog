...
export const pt = {
  ...
  // número não diz: de que série é, quantas obras tem e que aquilo abre.
  'shelf.stack': '{name}, {count} obras. Abrir',
  'shelf.stackOpen': '{name}, {count} obras. Fechar',
  ...
  'item.newSeasonConfirm': 'Voltar a assistir',
